      ...
      <table className="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="wd-login-id">00981562W</td>
          ...
          <tr>
            ...
            <td className="wd-login-id">002234963R</td>
          ...
          <tr>
            ...
            <td className="wd-login-id">000001221N</td>
            <td className="wd-section">S104</td>
            <td className="wd-role">STUDENT</td>
            <td className="wd-last-activity">2020-10-04</td>
            <td className="wd-total-activity">09:15:33</td>
          </tr>
        </tbody>
      </table>
    </div>);
